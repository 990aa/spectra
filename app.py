...
def analyze_image(
    image: Image.Image, class_text: str, model_id: str, threshold: float, top_k: int
):
    """
...
def process_video(
    video_path: str, class_text: str, model_id: str, threshold: float, frame_skip: int
):
    """
    ...
    with gr.Row():
        ...
        with gr.Column(scale=2):
            with gr.Tab("📸 Image Analysis"):
                ...
                gr.Examples(examples=[], inputs=image_input, label="Example Images")
